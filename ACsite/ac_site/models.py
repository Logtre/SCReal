...
class Region(models.Model):
    ...
    link_prefecture = models.OneToOneField('Prefecture', blank=True, null=True, db_column='link_prefecture_id', to_field='prefecture_id', related_name='link_region', on_delete=models.CASCADE, unique=True)
    link_city = models.IntegerField(default=0, unique=True) # city_idへのリンクはphase2以降に対応
...
class SummaryCapacityBreakdown(models.Model):
    ...
    region_summary = models.ForeignKey('RegionSummary', blank=True, null=True, db_column='region_summary_id', to_field='region_id', related_name='capacity_breakdown', on_delete=models.CASCADE)
...
class SummaryArticleBreakdown(models.Model):
    ...
    region_summary = models.ForeignKey('RegionSummary', blank=True, null=True, db_column='region_summary_id', to_field='region_id', related_name='article_breakdown', on_delete=models.CASCADE)
...
class SummarySizeBreakdown(models.Model):
    ...
    region_summary = models.ForeignKey('RegionSummary', blank=True, null=True, db_column='region_summary_id', to_field='region_id', related_name='size_breakdown', on_delete=models.CASCADE)
...
class SummaryLanguageBreakdown(models.Model):
    ...
    region_summary = models.ForeignKey('RegionSummary', blank=True, null=True, db_column='region_summary_id', to_field='region_id', related_name='language_breakdown', on_delete=models.CASCADE)
